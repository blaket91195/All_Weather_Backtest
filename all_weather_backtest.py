...
DOWNLOAD_DELAY = 0.25  # seconds between yfinance calls
...
def download_price(ticker, start="2005-01-01", end=None):
    """Download adjusted close for a single ticker, with retry."""
...
def download_all_prices(tickers, start="2005-01-01", end=None):
    ...
    print(f"Downloading data for {len(all_to_download)} tickers...")
    for t in all_to_download:
